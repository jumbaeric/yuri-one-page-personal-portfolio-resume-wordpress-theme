...
<div id="sidebar" class="col-md-4 order-md-first col-sm-12 order-sm-last">
	...
	?>
		<div id="widget-area" class="widget-area" role="complementary">
			...
			?>
				<span class="edit-link"><a href="<?php echo esc_url( admin_url( 'widgets.php' ) ); ?>" class="badge bg-secondary"><?php esc_html_e( 'Edit', 'yuri-lucas' ); ?></a></span><!-- Show Edit Widget link -->
			<?php
				endif;
			?>
		</div><!-- /.widget-area -->
	...
	?>
		<div class="bg-faded sidebar-nav">
			<div id="primary-two" class="widget-area">
				...
				<br />
				<ul class="categories">
					<li><h3><?php esc_html_e( 'Categories', 'yuri-lucas' ); ?></h3></li>
					<?php
					...
					?>
							<li>&nbsp;</li>
							<li><a href="<?php the_permalink( get_option( 'page_for_posts' ) ); ?>" class="btn btn-outline-secondary"><?php esc_html_e( 'more', 'yuri-lucas' ); ?></a></li>
					<?php
						endif;
					?>
				</ul>
